...
const ERAS = [
  ...
  { n: 'Město a doprava', d: 'Asfaltové silnice, nákladní auta, autobusy, radnice a čtvrti.', ok: () => (G.stats.made.plech || 0) >= 20 && G.cats.length >= 18, hint: 'vyrob 20 plechů a měj 18 koček' },
